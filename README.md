...
| sample | Coût | prompt |
| --- | --- | --- |
| <img src="assets/01-preview.jpg" width="260"> | $0.024 | `ruelle de Tokyo sous la pluie, reflets néon sur l'asphalte mouillé, rendu film 35mm` |
| <img src="assets/02-preview.jpg" width="260"> | $0.024 | `tasse en céramique en studio, lumière douce de fenêtre, objectif 85mm` |
